...
table_hdr = """
<table class="table table-condensed exp_table">
"""
...
def add_collapsable(s, output_file):
    output_file.write(('<div class="diffmisc"><td colspan="4">%s</td></div>\n'%convert(s)).encode(encoding))
...
def add_filename(output_file):
    output_file.write("<tr><th colspan='2'>修改前</th>")
    output_file.write("<th colspan='2'>修改后</th></tr>\n")
